...
public class VermessenLect : MonoBehaviour
{
    ...
    Vector3 jibStartPos, jibDefaultPos;
    Quaternion jibStartRot, jibDefaultRot;
    ...
    private void Start()
    {
        jibDefaultPos = jib.transform.position;
        jibDefaultRot = jib.transform.rotation;
    }
    ...
    void removeContent(GameObject currAR, GameObject currCtrl)
    {
        ...
        //jib.transform.position = jibDefaultPos;
        //jib.transform.rotation = jibDefaultRot;
    }
}
